...
@section('title',$service->title.' Alt Hizmet Ekleme')
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18"><A>{{$service->title}} Hizmet Ekleme</A></h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="{{ route('services.index') }}">Hizmet</a></li>
                                            <li class="breadcrumb-item"><a href="{{route('subservices.index',['id'=>$service->id])}}">Alt Hizmet</a></li>
                                            <li class="breadcrumb-item active">Alt Hizmet Ekleme</li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @include('admin.alert')
                                        <form action="{{route('subservices.store',['id'=>$service->id])}}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row mb-4">
                                            ...
                                            <div class="row justify-content-end">
                                                <div class="col-sm-9">
                                                    ...
                                                    <div>
                                                        <button type="submit" class="btn btn-primary w-md">Alt Hizmeti Ekle</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
