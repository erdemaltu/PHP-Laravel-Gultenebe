                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18"><A>Hizmet Ekleme</A></h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="{{ route('services.index') }}">Hizmet</a></li>
                                            <li class="breadcrumb-item active">Hizmet Ekleme</li>
                                        </ol>
                                    </div>
                                        ...
                                        <form action="{{route('services.store')}}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row justify-content-end">
                                                <div class="col-sm-9">
                                                    ...
                                                    <div>
                                                        <button type="submit" class="btn btn-primary w-md">Hizmeti Ekle</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
